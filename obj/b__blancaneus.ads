...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#afe14d67#;
   ...
   u00051 : constant Version_32 := 16#adc843f0#;
   pragma Export (C, u00051, "ada__real_timeB");
   u00052 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00052, "ada__real_timeS");
   u00053 : constant Version_32 := 16#c8eda0b7#;
   pragma Export (C, u00053, "system__taskingB");
   u00054 : constant Version_32 := 16#904e70c9#;
   pragma Export (C, u00054, "system__taskingS");
   u00055 : constant Version_32 := 16#fde20231#;
   pragma Export (C, u00055, "system__task_primitivesS");
   u00056 : constant Version_32 := 16#4a005d03#;
   pragma Export (C, u00056, "system__os_interfaceB");
   u00057 : constant Version_32 := 16#55598295#;
   pragma Export (C, u00057, "system__os_interfaceS");
   u00058 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00058, "interfaces__cB");
   u00059 : constant Version_32 := 16#467817d8#;
   pragma Export (C, u00059, "interfaces__cS");
   u00060 : constant Version_32 := 16#1b8990a4#;
   pragma Export (C, u00060, "interfaces__c__extensionsS");
   u00061 : constant Version_32 := 16#54ea2fd2#;
   pragma Export (C, u00061, "system__os_constantsS");
   u00062 : constant Version_32 := 16#9690f83e#;
   pragma Export (C, u00062, "system__task_primitives__operationsB");
   u00063 : constant Version_32 := 16#bd0bc49c#;
   pragma Export (C, u00063, "system__task_primitives__operationsS");
   u00064 : constant Version_32 := 16#89b55e64#;
   pragma Export (C, u00064, "system__interrupt_managementB");
   u00065 : constant Version_32 := 16#1a73cd21#;
   ...
   u00067 : constant Version_32 := 16#30f7f088#;
   pragma Export (C, u00067, "system__multiprocessorsS");
   u00068 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00068, "system__os_primitivesB");
   u00069 : constant Version_32 := 16#0fa60a0d#;
   pragma Export (C, u00069, "system__os_primitivesS");
   u00070 : constant Version_32 := 16#e0fce7f8#;
   pragma Export (C, u00070, "system__task_infoB");
   u00071 : constant Version_32 := 16#8841d2fa#;
   pragma Export (C, u00071, "system__task_infoS");
   u00072 : constant Version_32 := 16#1036f432#;
   pragma Export (C, u00072, "system__tasking__debugB");
   u00073 : constant Version_32 := 16#de1ac8b1#;
   ...
   u00082 : constant Version_32 := 16#19143a2a#;
   pragma Export (C, u00082, "system__img_lliS");
   u00083 : constant Version_32 := 16#3cdd1378#;
   pragma Export (C, u00083, "system__unsigned_typesS");
   u00084 : constant Version_32 := 16#6ec3c867#;
   pragma Export (C, u00084, "system__stack_usageB");
   u00085 : constant Version_32 := 16#3a3ac346#;
   ...
   u00088 : constant Version_32 := 16#e6d4fa36#;
   pragma Export (C, u00088, "ada__stringsS");
   u00089 : constant Version_32 := 16#457fb2da#;
   pragma Export (C, u00089, "ada__strings__unboundedB");
   u00090 : constant Version_32 := 16#f39c7224#;
   pragma Export (C, u00090, "ada__strings__unboundedS");
   u00091 : constant Version_32 := 16#2eb48a6d#;
   pragma Export (C, u00091, "ada__strings__searchB");
   u00092 : constant Version_32 := 16#c1ab8667#;
   ...
   u00098 : constant Version_32 := 16#4b7bb96a#;
   pragma Export (C, u00098, "ada__characters__latin_1S");
   u00099 : constant Version_32 := 16#d398a95f#;
   pragma Export (C, u00099, "ada__tagsB");
   u00100 : constant Version_32 := 16#12a0afb8#;
   pragma Export (C, u00100, "ada__tagsS");
   u00101 : constant Version_32 := 16#796f31f1#;
   pragma Export (C, u00101, "system__htableB");
   u00102 : constant Version_32 := 16#8c99dc11#;
   pragma Export (C, u00102, "system__htableS");
   u00103 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00103, "system__string_hashB");
   u00104 : constant Version_32 := 16#2ec7b76f#;
   pragma Export (C, u00104, "system__string_hashS");
   u00105 : constant Version_32 := 16#afdbf393#;
   pragma Export (C, u00105, "system__val_lluB");
   u00106 : constant Version_32 := 16#462f440a#;
   pragma Export (C, u00106, "system__val_lluS");
   u00107 : constant Version_32 := 16#269742a9#;
   pragma Export (C, u00107, "system__val_utilB");
   u00108 : constant Version_32 := 16#a4fbd905#;
   pragma Export (C, u00108, "system__val_utilS");
   u00109 : constant Version_32 := 16#ec4d5631#;
   pragma Export (C, u00109, "system__case_utilB");
   u00110 : constant Version_32 := 16#378ed9af#;
   pragma Export (C, u00110, "system__case_utilS");
   u00111 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00111, "system__compare_array_unsigned_8B");
   u00112 : constant Version_32 := 16#a1581e76#;
   ...
   u00114 : constant Version_32 := 16#1b57d1c8#;
   pragma Export (C, u00114, "system__address_operationsS");
   u00115 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00115, "system__storage_pools__subpoolsB");
   u00116 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00116, "system__storage_pools__subpoolsS");
   u00117 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00117, "system__finalization_mastersB");
   u00118 : constant Version_32 := 16#53a75631#;
   pragma Export (C, u00118, "system__finalization_mastersS");
   u00119 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00119, "system__img_boolB");
   u00120 : constant Version_32 := 16#fd821e10#;
   ...
   u00124 : constant Version_32 := 16#92d882c5#;
   ...
   u00126 : constant Version_32 := 16#47a91c6b#;
   ...
   u00128 : constant Version_32 := 16#2bb6f156#;
   ...
   u00136 : constant Version_32 := 16#1ffab6e1#;
   ...
   u00140 : constant Version_32 := 16#af2a8e9e#;
   pragma Export (C, u00140, "system__file_ioS");
   u00141 : constant Version_32 := 16#0f8892f9#;
   pragma Export (C, u00141, "system__os_libB");
   u00142 : constant Version_32 := 16#d8e681fb#;
   pragma Export (C, u00142, "system__os_libS");
   u00143 : constant Version_32 := 16#2a8e89ad#;
   pragma Export (C, u00143, "system__stringsB");
   u00144 : constant Version_32 := 16#684d436e#;
   pragma Export (C, u00144, "system__stringsS");
   u00145 : constant Version_32 := 16#f5c4f553#;
   pragma Export (C, u00145, "system__file_control_blockS");
   u00146 : constant Version_32 := 16#21b0c977#;
   pragma Export (C, u00146, "def_monitorB");
   u00147 : constant Version_32 := 16#73a29e31#;
   pragma Export (C, u00147, "def_monitorS");
   u00148 : constant Version_32 := 16#9fcf5d7f#;
   pragma Export (C, u00148, "system__tasking__protected_objectsB");
   u00149 : constant Version_32 := 16#b15a1586#;
   pragma Export (C, u00149, "system__tasking__protected_objectsS");
   u00150 : constant Version_32 := 16#9f1b5cb1#;
   pragma Export (C, u00150, "system__soft_links__taskingB");
   u00151 : constant Version_32 := 16#e939497e#;
